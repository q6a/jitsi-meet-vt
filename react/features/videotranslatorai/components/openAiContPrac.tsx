...
const OpenAiContPrac: FC = () => {
            ...
            const initializeRnnoise = async () => {
                try {
                    ...
                    scriptProcessor.onaudioprocess = (event) => {
                        const pcmFrame = event.inputBuffer.getChannelData(0).slice(0, 512);
    ...
    useEffect(() => {
        if (sendDataWhenReady) {
            ...
            console.log("DATA TO BE SENT", audioBlob);
