...
import { setRecordingBlobOpenAi, startRecordingOpenAi, stopRecordingOpenAi, translateOpenAi } from "../action.web";
...
const TranscriptionAndTranslationOpenAiButton: FC = () => {
    ...
    const handleTranslation = (recordedBlob) => {
    ...
    const handleOnStop = async (recordedBlob: any) => {
        ...
        handleTranslation(recordedBlob);
