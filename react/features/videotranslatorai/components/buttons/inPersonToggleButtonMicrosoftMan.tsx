...
const InPersonToggleButtonMicrosoftMan: FC<InPersonButtonMicrosoftManProps> = ({
    isAudioMuted,
    isRecordingOther,
    isRecording,
    personName,
    ...
    const handleStartRecording = async () => {
        if (isRecordingOther || isAudioMuted || !isRecording) {
            return;
        }
...
export default InPersonToggleButtonMicrosoftMan;
